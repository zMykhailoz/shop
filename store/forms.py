...
from store.models import Profile, ProductRating
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields[
            'new_password1'].help_text = ('<ul class="form-text text-muted small">'
                                          ...
                                          '</li><li>Your password must contain at least 8 characters.</li><li>'
                                          'Your password can\'t be a commonly used password.</li><li>'
